...
# Remove Raspberry Pi functionality 
raspberry_pi = ["GpioPin", "GpioPinValue"]


# Class to construct structs
class StructOSaurusRex():
    # Function to convert types from CPP types to C# types
    def convert_type(self, type):
        ...
        if type in swappable_names:
            ...
            return type
    # Function used to strip types for calling SplashKit methods inside of a relevant class
    ...
    # Function to get struct information and signature 
    def get_struct_name(self, line, struct_index):
        ...
        for attribute in line[struct_index]["fields"].keys():
            ...
            # Replace void types to pointers inline with SK translator
    ...
    # Function to get function methods
...
# function used to replace this in certain classes
...
# Function to generate bindings for functions within each of class with the api.json file
def get_bindings(line):
    ...
    for definition in line["signatures"]["csharp"]:
        ...
        # Remove unsupported types and functions
...
for SK_class in classes:
    ...
    # remove raspberry Pi related classes and certain other ghost classes. These classes don't exist and are actaully structs
